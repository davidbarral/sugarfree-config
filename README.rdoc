...
In rails 2.x gems were required after Rails.root is initialized. Default rails 3.0
application generator uses Bundler, and auto-requires all gems before application
initialization. This could be solved setting in Gemfile:

  "gem 'problem-gem', :require => false

and separating "require 'problem-gem'" in initializer
